...
<head>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/<?php echo $this->data['baseurlpath']; ?>module/ntktheme/assets/css/stylesheet.css?ver=<?php echo urlencode($this->configuration->getVersion()); ?>" />
        ...
        <?php } else { ?>
            <link rel="icon" href="/<?php echo $this->data['baseurlpath']; ?>module/ntktheme/resources/favicon.png" sizes="32x32">
            <link rel="icon" href="/<?php echo $this->data['baseurlpath']; ?>module/ntktheme/resources/favicon.png" sizes="192x192" />
            <link rel="apple-touch-icon-precomposed" href="/<?php echo $this->data['baseurlpath']; ?>module/ntktheme/resources/favicon.png">
        <?php
        }
        $jquery['css'] = true;
        if (!empty($jquery)) {
    ...
    <body<?php echo $onLoad; ?> data-languages="[]">
        ...
        <nav class="navbar navbar-toggleable-md navbar-dark">
            ...
            <a class="navbar-brand mr-auto" href="/<?php echo $this->data['baseurlpath']; ?>">
                <img id="brandLogo" src="/<?php echo $this->data['baseurlpath']; ?>module/ntktheme/resources/notakey-white-nobg.svg" height="30" alt="Notakey">
            </a>
        </nav>
